...
def get_wholesale_purchase_plan(wholesale_catalog: list[Barrel]):
    ...
    return barrel_plan_calculation(wholesale_catalog, ml_needed, ml_stored, usable_gold, ml_capacity)
...
if __name__ == "__main__":
    ...
    ml_stored = [5100,500,500,0]
    usable_gold = 500
    ml_capacity = 20000
    simplified_plan(barrel_catalog, ml_needed, ml_stored, usable_gold, ml_capacity)
    print("\nSEPERATOR\n")
    barrel_plan_calculation(barrel_catalog, ml_needed, ml_stored, usable_gold, ml_capacity)
